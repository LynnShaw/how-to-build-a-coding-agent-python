#!/usr/bin/env python3
"""
Code Search Tool – Search code patterns using ripgrep
"""
...
def main():
    parser = argparse.ArgumentParser(description="Chat with LLM - File Reading, Listing, Bash, and Code Search Tools")
