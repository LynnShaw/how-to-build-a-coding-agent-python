#!/usr/bin/env python3
"""
List Files Tool - LLM can browse directories
"""
...
def main():
    parser = argparse.ArgumentParser(description="Chat with LLM - File Reading and Listing Tools")
    ...
    tools = [ReadFileDefinition, ListFilesDefinition]
    if args.verbose:
