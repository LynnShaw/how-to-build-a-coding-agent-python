#!/usr/bin/env python3
"""
Bash Command Tool – LLM can execute shell commands
"""
...
def main():
    parser = argparse.ArgumentParser(description="Chat with LLM - File Reading, Listing, and Bash Tools")
    ...
    tools = [ReadFileDefinition, ListFilesDefinition, BashDefinition]
    if args.verbose:
